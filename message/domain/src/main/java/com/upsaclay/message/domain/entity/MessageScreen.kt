...
sealed class MessageScreen: Screen {
    data class Chat(val conversation: ChatConversation): MessageScreen() {
    ...
    data object Conversation: MessageScreen() {
        override val route: String = CONVERSATION_ROUTE
    }

    data object CreateConversation: MessageScreen() {
